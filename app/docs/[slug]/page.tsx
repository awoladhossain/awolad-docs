...
// Code Playground Integrations
import { PlaygroundProvider } from '@/components/PlaygroundContext';
import InteractivePlayground from '@/components/InteractivePlayground';
import PlaygroundToggleButton from '@/components/PlaygroundToggleButton';
import PlaygroundMainWrapper from '@/components/PlaygroundMainWrapper';
import PlaygroundCodeBlock from '@/components/PlaygroundCodeBlock';
    ...
    <PlaygroundProvider>
      <div className="min-h-screen bg-[#09090b] text-white antialiased">
        <div className="flex">
          ...
          {/* Main Content Pane wrapped in responsive sliding wrapper */}
